...
var file_task_service_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x73, 0x6b, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xdd, 0x01, 0x0a, 0x11, 0x54, 0x61, 0x73,
	...
	0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x12, 0x0a, 0x10, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x6f,
	0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9f, 0x0b, 0x0a, 0x0d, 0x4d,
	...
	0x0b, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x5e, 0x0a, 0x12,
...
var file_task_service_proto_depIdxs = []int32{
	...
	2,  // 15: task.service.v1.TaskService.TaskStages:output_type -> task.service.v1.TaskStagesResponse
	4,  // 16: task.service.v1.TaskService.MemberProjectList:output_type -> task.service.v1.MemberProjectResponse
	7,  // 17: task.service.v1.TaskService.TaskList:output_type -> task.service.v1.TaskListResponse
	5,  // 18: task.service.v1.TaskService.SaveTask:output_type -> task.service.v1.TaskMessage
	8,  // 19: task.service.v1.TaskService.TaskSort:output_type -> task.service.v1.TaskSortResponse
	10, // 20: task.service.v1.TaskService.MyTaskList:output_type -> task.service.v1.MyTaskListResponse
	5,  // 21: task.service.v1.TaskService.ReadTask:output_type -> task.service.v1.TaskMessage
