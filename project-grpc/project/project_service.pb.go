...
type ProjectMessage struct {
	...
	ProjectCode        int64   `protobuf:"varint,25,opt,name=ProjectCode,proto3" json:"ProjectCode,omitempty"` // projectMemberUnion 表的内容也加进来；
...
type ProjectRpcMessage struct {
	...
	Page     int64 `protobuf:"varint,2,opt,name=page,proto3" json:"page,omitempty"`         // 分页信息；
	PageSize int64 `protobuf:"varint,3,opt,name=pageSize,proto3" json:"pageSize,omitempty"` // 页size
}
