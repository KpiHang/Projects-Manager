...
type ProjectRepo interface {
	...
	FindProjectByMemId(ctx context.Context, memId int64, condition string, page int64, pageSize int64) ([]*data.ProjectAndMember, int64, error)
	FindCollectProjectByMemId(ctx context.Context, memId int64, page int64, pageSize int64) ([]*data.ProjectAndMember, int64, error)
